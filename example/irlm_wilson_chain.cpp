...
{
    int len=30;
    IRLM_wilson_chain model {.L=len, .t0=0.75, .Lambda=1.5, .V=0.1, .U=0.25, .ed=-10};
    ...
    auto sys2=IRLM_wilson_chain {.L=len, .t0=0.75, .Lambda=1.5, .V=0.1, .U=0.25, .ed=0}.HamStar();
