#ifndef IT_TDVP_ERROR_H
#define IT_TDVP_ERROR_H
...
tdvpError(MPS & psi,
    ...
    {
    LocalMPO PH(H,args);
    Real energy = TDVPErrorWorker(psi,PH,t,sweeps,args);
    return energy;
    }

//
//TDVPError with an MPO and custom DMRGObserver
//
Real inline
tdvpError(MPS & psi,
     MPO const& H,
    ...
    {
    LocalMPO PH(H,args);
    Real energy = TDVPErrorWorker(psi,PH,t,sweeps,obs,args);
    return energy;
    }

//
//TDVPError with an MPO and boundary tensors LH, RH
// LH - H1 - H2 - ... - HN - RH
...
//
//TDVPError with a set of MPOs (lazily summed)
...
//
//TDVPError with a set of MPOs and a custom DMRGObserver
//(H vector is 0-indexed)
//
Real inline
tdvpError(MPS & psi,
